...
export default function SignupPage() {
  ...
  return (
    <AuthSplitLayout
      ...
      heading="Start your creator journey"
      subheading="Create your DealerEth account and start receiving structured campaign opportunities from brands."
      steps={["Create your account", "Set up your profile", "Share profile link and receive deals"]}
      formTitle="Create Creator Account"
      formSubtitle="Create your account details below and continue with DealerEth onboarding."
    ...
    >
      ...
      <form className="space-y-3" onSubmit={onSubmit}>
        ...
        <Input
          name="username"
          type="text"
          placeholder="Username (e.g. selam_creates)"
          className="rounded-xl border-white/10 bg-white/5 text-white placeholder:text-white/40 focus:border-[#25F4EE]/50"
        />
        <Input
          name="tiktokHandle"
          type="text"
          placeholder="TikTok handle (e.g. @selam_21)"
          className="rounded-xl border-white/10 bg-white/5 text-white placeholder:text-white/40 focus:border-[#25F4EE]/50"
        />
        <Input
          name="email"
