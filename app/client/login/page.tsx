...
export default function ClientLoginPage() {
  ...
  return (
    <AuthSplitLayout
      badge="Brand Portal"
      heading="Welcome back, Brand"
      subheading="Sign in to launch campaigns, discover creators, and manage collaborations from one dashboard."
      steps={["Sign in to your brand account", "Post campaigns with budget details", "Track creator responses"]}
      formTitle="Brand Sign In"
      formSubtitle="Continue where your team left off. You can also continue instantly with TikTok."
      footerText="New here?"
