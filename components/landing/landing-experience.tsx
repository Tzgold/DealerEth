...
export function LandingExperience() {
  ...
  return (
    <div className="editorial-shell min-h-screen overflow-hidden">
      ...
      <footer className="border-t border-white/[0.07]"><div className="mx-auto flex max-w-[1240px] flex-wrap items-center justify-between gap-5 px-5 py-8 text-sm text-white/45 sm:px-8"><p><span className="font-black text-white">dealerEth</span> · Creator partnerships, made clearer.</p><div className="flex flex-wrap gap-5"><a href="#how" className="landing-footer-link">How it works</a><a href="#faq" className="landing-footer-link">FAQ</a><Link href="/terms" className="landing-footer-link">Terms</Link><Link href="/privacy" className="landing-footer-link">Privacy</Link><Link href="/login" className="landing-footer-link">Sign in</Link></div></div></footer>
