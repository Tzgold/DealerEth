...
export function BrandDashboardShell({
  ...
  return (
    <div className="dashboard-surface brand-shell min-h-screen text-white">
      ...
      <nav className="fixed inset-x-0 bottom-0 z-40 overflow-x-auto border-t border-white/10 bg-[#101012]/95 px-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] pt-2 backdrop-blur md:hidden" aria-label="Brand dashboard">
