export function StatTile({ label, value, tone }: { label: string; value: string; tone?: "default" | "accent" }) {
  return (
    <div className="rounded-2xl border border-white/10 bg-[#141416] px-4 py-4 shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
      <p className={`text-2xl font-black tracking-tight ${tone === "accent" ? "text-[#FE7A1E]" : "text-white"}`}>{value}</p>
